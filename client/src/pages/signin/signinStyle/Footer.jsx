    ...
    <FooterContainer>
      <FooterWrap>
        <FooterLinkContainer>
          <FooterLinkWrapper>
            <FooterLinkItems>
              <FooterLinkTitle>Creators</FooterLinkTitle>
                <FooterLink to= {{ pathname:'https://www.linkedin.com/in/alok-p-200381127/'}} target="_blank">Liza wanjiku</FooterLink>
                <FooterLink to= {{ pathname:'https://www.linkedin.com/in/keshav-gautam-862741196/'}} target="_blank">Lucy mbugua</FooterLink>
                <FooterLink to= {{ pathname:'https://www.linkedin.com/in/eshan-agarwal-557418118/'}} target="_blank">Gretchen Nduta</FooterLink>
            </FooterLinkItems>
            <FooterLinkItems>
          ...
          <FooterLinkWrapper>
            <FooterLinkItems>
              <FooterLinkTitle>Covid-19 data</FooterLinkTitle>
                <FooterLink to= {{ pathname:'https://timesofindia.indiatimes.com/india/coronavirus-lockdown-in-india-covid-19-vaccine-cases-live-updates-12-april-2021/liveblog/82023278.cms'}} target="_blank">In Kenya</FooterLink>
          ...
          <SocialMediaWrap>
            <WebsiteRights>Created on 10/10/2024</WebsiteRights>
          </SocialMediaWrap>
      </FooterWrap>
    </FooterContainer>
  )
